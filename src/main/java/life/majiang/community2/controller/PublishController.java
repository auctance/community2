...
public class PublishController {
    ...
    public String doPublish(
        ...
        if (title == null || title == ""){
            model.addAttribute("error","title not allowed null");
            return "publish";
        }
        if (description == null || description == ""){
            model.addAttribute("error","description not allowed null");
            return "publish";
        }
        if (tag == null || tag == ""){
            model.addAttribute("error","tag not allowed null");
            return "publish";
        }
        ...
        if (user==null){
            model.addAttribute("error","user not login in");
            return "publish";
        }
